...
Q_DECLARE_METATYPE(P3::ProjectManager::GemInfo);

Q_DECLARE_OPERATORS_FOR_FLAGS(P3::ProjectManager::GemInfo::Platforms);
Q_DECLARE_OPERATORS_FOR_FLAGS(P3::ProjectManager::GemInfo::Types);
Q_DECLARE_OPERATORS_FOR_FLAGS(P3::ProjectManager::GemInfo::GemOrigins);
