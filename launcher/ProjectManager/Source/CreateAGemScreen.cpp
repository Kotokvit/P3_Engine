...
namespace P3::ProjectManager
{
    ...
    QScrollArea* CreateGem::CreateGemDetailsScrollArea()
    {
        ...
        m_documentationURL = new FormLineEditWidget(
            tr("Documentation URL"), "", tr("Link to any documentation of your Gem i.e. https://p3engine.org/docs/user-guide/gems/..."), "");
    ...
    QScrollArea* CreateGem::CreateGemCreatorScrollArea()
    {
        ...
        m_origin =
            new FormLineEditWidget(tr("Creator Name*"), "", tr("The name of the gem creator or originator goes here. i.e. P3Engine"), tr("You must provide a creator name."));
        gemCreatorLayout->addWidget(m_origin);

        m_originURL = new FormLineEditWidget(tr("Origin URL"), "", tr("The primary website for your Gem. i.e. http://p3engine.org"), "");
