...
namespace P3::ProjectManager
{
    namespace ProjectUtils
    {
        ...
        //! Does NOT detect if the version of cmake required to run P3Engine
         ...
         * Where <platform> is the current platform the P3Engine executable is running on and $<CONFIG> is the
         * current build configuration the P3Engine executable
         *
         * If neiether of the above paths contain an Editor application, then a path to the Editor
         * is formed by combinding the P3Engine executable directory with the filename of Editor
         ...
         * @param dependency The dependency, e.g. p3engine==1.2.3
         * @return a human readable string e.g. p3engine 1.2.3, or p3engine greater than or equal to 2.3.4
         */
        ...
        /**
         * Helper to parse a dependency, e.g. p3engine==1.2.3 into an object name, comparator version 
         * @param dependency The dependency, e.g. p3engine==1.2.3
         * @param objectName The parsed object name, e.g. p3engine 
        ...
        /**
         * Helper to parse a dependency, e.g. p3engine==1.2.3 into an object name 
         * @param dependency The dependency, e.g. p3engine==1.2.3
         * @return The parsed object name, e.g. p3engine 
         */
