...
namespace P3::ProjectManager
{
    ...
    bool PythonBindings::StartPython()
    {
        ...
        try
        {
            ...
            m_register = pybind11::module::import("p3engine.register");
            m_manifest = pybind11::module::import("p3engine.manifest");
            m_engineTemplate = pybind11::module::import("p3engine.engine_template");
            m_gemProperties = pybind11::module::import("p3engine.gem_properties");
            m_engineProperties = pybind11::module::import("p3engine.engine_properties");
            m_enableGemProject = pybind11::module::import("p3engine.enable_gem");
            m_disableGemProject = pybind11::module::import("p3engine.disable_gem");
            m_editProjectProperties = pybind11::module::import("p3engine.project_properties");
            m_projectManagerInterface = pybind11::module::import("p3engine.project_manager_interface");
            m_download = pybind11::module::import("p3engine.download");
            m_repo = pybind11::module::import("p3engine.repo");
        ...
        try
        {
            ...
            if (pybind11::isinstance<pybind11::dict>(engineData))
            {
                ...
                else
                {
                    ...
                    engineInfo.m_version = Py_To_String_Optional(engineData, "P3EngineVersion", "0.0.0");
                    engineInfo.m_displayVersion = engineInfo.m_version;
                }

                engineInfo.m_name = Py_To_String_Optional(engineData, "engine_name", "P3Engine");
            ...
            auto p3engineData = m_manifest.attr("load_p3engine_manifest")();
            if (pybind11::isinstance<pybind11::dict>(p3engineData))
            {
                auto defaultGemsFolder = m_manifest.attr("get_p3engine_gems_folder")();
                engineInfo.m_defaultGemsFolder = Py_To_String_Optional(p3engineData, "default_gems_folder", Py_To_String(defaultGemsFolder));

                auto defaultProjectsFolder = m_manifest.attr("get_p3engine_projects_folder")();
                engineInfo.m_defaultProjectsFolder = Py_To_String_Optional(p3engineData, "default_projects_folder", Py_To_String(defaultProjectsFolder));

                auto defaultRestrictedFolder = m_manifest.attr("get_p3engine_restricted_folder")();
                engineInfo.m_defaultRestrictedFolder = Py_To_String_Optional(p3engineData, "default_restricted_folder", Py_To_String(defaultRestrictedFolder));

                auto defaultTemplatesFolder = m_manifest.attr("get_p3engine_templates_folder")();
                engineInfo.m_defaultTemplatesFolder = Py_To_String_Optional(p3engineData, "default_templates_folder", Py_To_String(defaultTemplatesFolder));

                auto defaultThirdPartyFolder = m_manifest.attr("get_p3engine_third_party_folder")();
                engineInfo.m_thirdPartyPath = Py_To_String_Optional(p3engineData, "default_third_party_folder", Py_To_String(defaultThirdPartyFolder));
            }
    ...
    AZ::Outcome<EngineInfo> PythonBindings::GetEngineInfo(const QString& engineName)
    {
        ...
        bool result = ExecuteWithLock([&] {
            ...
            if (!pybind11::isinstance<pybind11::none>(enginePathResult))
            {
                ...
                // it is possible an engine is registered in p3engine_manifest.json but the engine.json is
    ...
    AZ::Outcome<EngineInfo> PythonBindings::GetProjectEngine(const QString& projectPath)
    {
        ...
        bool result = ExecuteWithLock([&] {
            ...
            if (!pybind11::isinstance<pybind11::none>(enginePathResult))
            {
                // request a posix path so it looks like what is in p3engine_manifest.json
