...
{
    //! Interface used to interact with the p3engine cli python functions
    class IPythonBindings
    {
    public:
        AZ_RTTI(P3::ProjectManager::IPythonBindings, "{C2B72CA4-56A9-4601-A584-3B40E83AA17C}");
        ...
        /**
         * Registers the gem to the specified project, or to the p3engine_manifest.json if no project path is given
         * @param gemPath the path to the gem
         * @param projectPath the path to the project. If empty, will register the external path in p3engine_manifest.json
         * @return An outcome with the success flag as well as an error message in case of a failure.
         */
        virtual AZ::Outcome<void, AZStd::string> RegisterGem(const QString& gemPath, const QString& projectPath = {}) = 0;

        /**
         * Unregisters the gem from the specified project, or from the p3engine_manifest.json if no project path is given
         * @param gemPath the path to the gem
         * @param projectPath the path to the project. If empty, will unregister the external path in p3engine_manifest.json
         * @return An outcome with the success flag as well as an error message in case of a failure.
         */
