...
namespace P3::ProjectManager
{
    ...
    {
    public:
        AZ_RTTI(P3::ProjectManager::ISettings, "{95D87D95-0E04-462F-8B0B-ED15C0A9F090}");
        AZ_DISABLE_COPY_MOVE(ISettings);

        static constexpr char ProjectManagerKeyPrefix[] = "/P3Engine/ProjectManager";
        static constexpr char ExternalLinkWarningKey[] = "/P3Engine/ProjectManager/SkipExternalLinkWarning";
        static constexpr char ProjectsBuiltSuccessfullyKey[] = "/P3Engine/ProjectManager/SuccessfulBuildPaths";
