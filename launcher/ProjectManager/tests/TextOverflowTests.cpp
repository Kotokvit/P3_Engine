...
namespace P3::ProjectManager
{
    ...
    TEST_F(TextOverflowWidgetTests, ElideText_UnderMaxLength_NoOverflow)
    {
        ...
        testStr = "1234<a href='https://www.p3engine.org/'>56</a>7890";
        resultStr = TextOverflowLabel::ElideLinkedText(testStr, s_testLength);
        EXPECT_FALSE(EndsWithOverflowLink(resultStr));
    }
    ...
    TEST_F(TextOverflowWidgetTests, ElideText_OverMaxLength_ShowOverflow)
    {
        ...
        testStr = "1234<a href='https://www.p3engine.org/'>56</a>78901234<a href='https://www.p3engine.org/'>56</a>7890";
        resultStr = TextOverflowLabel::ElideLinkedText(testStr, s_testLength);
        EXPECT_TRUE(EndsWithOverflowLink(resultStr));
    }
    ...
    TEST_F(TextOverflowWidgetTests, ElideText_OverMaxLength_CorrectTruncation)
    {
        ...
        testStr = "1234<a href='https://www.p3engine.org/'>56</a>78901234567890";
        resultStr = TextOverflowLabel::ElideLinkedText(testStr, s_testLength);
        EXPECT_TRUE(resultStr.startsWith(QString("1234<a href='https://www.p3engine.org/'>56</a>7890 ")));
    }

    TEST_F(TextOverflowWidgetTests, ElideText_OverMaxLengthAtOpeningTag_OpeningTagNotIncluded)
    {
        QString testStr = "1234567890<a href='https://www.p3engine.org/'>1</a>";
        QString resultStr = TextOverflowLabel::ElideLinkedText(testStr, s_testLength);
    ...
    {
        QString testStr = "12345678<a href='https://www.p3engine.org/'>901234567890</a>";
        QString resultStr = TextOverflowLabel::ElideLinkedText(testStr, s_testLength);
        EXPECT_TRUE(resultStr.startsWith(QString("12345678<a href='https://www.p3engine.org/'>90</a> ")));
    }
} // namespace P3::ProjectManager
