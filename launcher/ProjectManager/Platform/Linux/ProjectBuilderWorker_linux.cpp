...
namespace P3::ProjectManager
{
    ...
    {
        // Attempt to use the Ninja build system if it is installed (described in the p3engine documentation) if possible,
        ...
        QStringList generateProjectArgs = QStringList{ProjectCMakeCommand,
                                                      ...
                                                      QString("-DP3_3RDPARTY_PATH=").append(thirdPartyPath)};
