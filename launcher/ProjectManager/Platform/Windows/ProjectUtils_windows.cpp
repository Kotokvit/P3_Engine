/*
 * Copyright (c) Contributors to the P3 Engine Project. For complete copyright and license terms please see the LICENSE at the root of this distribution.
 *
...
namespace P3::ProjectManager
{
    namespace ProjectUtils
    {
        ...
        AZ::Outcome<void, QString> SetupCommandLineProcessEnvironment()
        {
            ...
            // prepend cmake path to the current environment PATH - we prefer to use the one we ship P3Engine
            ...
            if (!cmakeVersionQueryResult.IsSuccess())
            {
                return AZ::Failure(
                    QObject::tr("CMake not found. \n\n"
                                ...
                                "Refer to the <a href='https://p3engine.org/docs/welcome-guide/setup/requirements/#cmake'>P3Engine "
            ...
            if (!ninjaQueryResult.IsSuccess())
            {
                return AZ::Failure(
                    QObject::tr("Ninja.exe Build System was not found in the PATH environment variable.<br>"
                                ...
                                "After installation, you may have to restart P3Engine's Project Manager.<br><br>"
                                "Refer to the <a href='https://p3engine.org/docs/welcome-guide/setup/requirements/#cmake'>P3Engine "
                                "requirements</a> for more information."));
            }
        ...
        AZ::Outcome<QString, QString> FindSupportedCompilerForPlatform(const ProjectInfo& projectInfo)
        {
                        ...
                        if (vsWhereCompilerVersionProcess.waitForStarted() && vsWhereCompilerVersionProcess.waitForFinished())
                        {
                            ...
                            return AZ::Success(
                                       QObject::tr(
                                           ...
                                           "href='https://p3engine.org/docs/welcome-guide/requirements/#microsoft-visual-studio'>Visual "
                        ...
                        if (vsWhereCompilerVersionProcess.waitForStarted() && vsWhereCompilerVersionProcess.waitForFinished())
                        {
                            ...
                            return AZ::Success(
                                       QObject::tr(
                                           ...
                                           "P3Engine will attempt to build the project with it, but there may be issues."
                                           "  P3Engine officially supports Visual Studio 2022 v17.14 or higher, and 2026 v18.1 or higher."
                                           "<br><br>Refer to the <a "
                                           "href='https://p3engine.org/docs/welcome-guide/requirements/#microsoft-visual-studio'>Visual "
                                           "Studio requirements</a> for more information."))
                                .arg(vsWhereCompilerVersionOutput.trimmed());
            ...
            return AZ::Failure(
                QObject::tr("No compatible C++ Compiler found.<br><br>"
                            "P3Engine officially supports Visual Studio 2022 v17.14 or higher, and 2026 v18.1 or higher.<br>"
                            ...
                            "Refer to the <a href='https://p3engine.org/docs/welcome-guide/requirements/#microsoft-visual-studio'>Visual "
                            "Studio requirements</a> for more information."));
        }
        ...
        AZ::IO::FixedMaxPath GetEditorExecutablePath(const AZ::IO::PathView& projectPath)
        {
            ...
            // Fall back to checking if an Editor exists in P3Engine executable directory
