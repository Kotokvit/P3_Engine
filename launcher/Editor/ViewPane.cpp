...
void CLayoutViewPane::OnActionRegistrationHook()
{
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.viewport.resizeIcon";
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.viewport.menuIcon";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.viewport.info.toggle";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.viewport.info.normal";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.viewport.info.full";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.viewport.info.compact";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.viewport.info.none";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    for (size_t i = 0; i < ViewportRatiosCount; ++i)
    {
        ...
        AZStd::string actionIdentifier = AZStd::string::format("p3engine.action.viewport.size.ratio[%i:%i]", width, height);
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.viewport.size.ratio.custom";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    for (size_t i = 0; i < ViewportResolutionsCount; ++i)
    {
        ...
        AZStd::string actionIdentifier = AZStd::string::format("p3engine.action.viewport.size.resolution[%i:%i]", width, height);
        AzToolsFramework::ActionProperties actionProperties;
        actionProperties.m_name = AZStd::string::format("%i:%i", width, height);
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.viewport.size.resolution.custom";
        AzToolsFramework::ActionProperties actionProperties;
        actionProperties.m_name = "Custom...";
        actionProperties.m_category = "Viewport Size Resolution";
...
void CLayoutViewPane::OnMenuBindingHook()
{
    // Camera
    {
        m_menuManagerInterface->AddWidgetToMenu(EditorIdentifiers::ViewportCameraMenuIdentifier, "p3engine.widgetAction.viewport.fieldOfView", 100);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportCameraMenuIdentifier, "p3engine.action.view.goToPosition", 200);
        ...
        m_menuManagerInterface->AddWidgetToMenu(
            EditorIdentifiers::ViewportCameraMenuIdentifier, "p3engine.widgetAction.viewport.cameraSpeedScale", 400);
    }

    // Debug Info
    {
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportDebugInfoMenuIdentifier, "p3engine.action.viewport.info.normal", 100);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportDebugInfoMenuIdentifier, "p3engine.action.viewport.info.full", 200);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportDebugInfoMenuIdentifier, "p3engine.action.viewport.info.compact", 300);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportDebugInfoMenuIdentifier, "p3engine.action.viewport.info.none", 400);
    }

    // Helpers
    {
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportHelpersMenuIdentifier, "p3engine.action.view.toggleIcons", 100);
        m_menuManagerInterface->AddSeparatorToMenu(EditorIdentifiers::ViewportHelpersMenuIdentifier, 200);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportHelpersMenuIdentifier, "p3engine.action.view.showHelpers", 300);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportHelpersMenuIdentifier, "p3engine.action.view.showSelectedEntityHelpers", 400);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportHelpersMenuIdentifier, "p3engine.action.view.hideHelpers", 500);
    }
    ...
    // Size
    {
        m_menuManagerInterface->AddSubMenuToMenu(EditorIdentifiers::ViewportSizeMenuIdentifier, EditorIdentifiers::ViewportSizeRatioMenuIdentifier, 100);
        {
            ...
            m_menuManagerInterface->AddActionToMenu(
                ...
                "p3engine.action.viewport.size.ratio.custom",
        ...
        m_menuManagerInterface->AddSubMenuToMenu(EditorIdentifiers::ViewportSizeMenuIdentifier, EditorIdentifiers::ViewportSizeResolutionMenuIdentifier, 200);
        {
            ...
            m_menuManagerInterface->AddActionToMenu(
                ...
                "p3engine.action.viewport.size.resolution.custom",
    ...
    // Options
    {
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportOptionsMenuIdentifier, "p3engine.action.edit.snap.toggleGridSnapping", 300);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportOptionsMenuIdentifier, "p3engine.action.edit.snap.toggleShowingGrid", 400);
        m_menuManagerInterface->AddWidgetToMenu(EditorIdentifiers::ViewportOptionsMenuIdentifier, "p3engine.widgetAction.viewport.gridSnappingSize", 500);
        m_menuManagerInterface->AddSeparatorToMenu(EditorIdentifiers::ViewportOptionsMenuIdentifier, 600);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportOptionsMenuIdentifier, "p3engine.action.edit.snap.toggleAngleSnapping", 700);
        m_menuManagerInterface->AddWidgetToMenu(EditorIdentifiers::ViewportOptionsMenuIdentifier, "p3engine.widgetAction.viewport.angleSnappingSize", 800);
    }
}

void CLayoutViewPane::OnToolBarBindingHook()
{
    m_toolBarManagerInterface->AddWidgetToToolBar(EditorIdentifiers::ViewportTopToolBarIdentifier, "p3engine.widgetAction.expander", 300);
    m_toolBarManagerInterface->AddWidgetToToolBar(
        EditorIdentifiers::ViewportTopToolBarIdentifier, "p3engine.widgetAction.prefab.editVisualMode", 400);
    m_toolBarManagerInterface->AddActionWithSubMenuToToolBar(
        EditorIdentifiers::ViewportTopToolBarIdentifier, "p3engine.action.view.goToPosition", EditorIdentifiers::ViewportCameraMenuIdentifier, 500);
    m_toolBarManagerInterface->AddActionWithSubMenuToToolBar(
        EditorIdentifiers::ViewportTopToolBarIdentifier, "p3engine.action.viewport.info.toggle", EditorIdentifiers::ViewportDebugInfoMenuIdentifier, 600);
    m_toolBarManagerInterface->AddActionWithSubMenuToToolBar(
        EditorIdentifiers::ViewportTopToolBarIdentifier, "p3engine.action.view.showHelpers", EditorIdentifiers::ViewportHelpersMenuIdentifier, 700);
    m_toolBarManagerInterface->AddActionWithSubMenuToToolBar(
        EditorIdentifiers::ViewportTopToolBarIdentifier, "p3engine.action.viewport.resizeIcon", EditorIdentifiers::ViewportSizeMenuIdentifier, 800);
    m_toolBarManagerInterface->AddActionWithSubMenuToToolBar(
        EditorIdentifiers::ViewportTopToolBarIdentifier, "p3engine.action.viewport.menuIcon", EditorIdentifiers::ViewportOptionsMenuIdentifier, 900);
}
