...
void CCryEditDoc::DeleteContents()
{
    ...
    P3SystemEventBus::Broadcast(&P3SystemEventBus::Events::OnCryEditorCloseScene);
    ...
    P3SystemEventBus::Broadcast(&P3SystemEventBus::Events::OnCryEditorSceneClosed);
}
...
bool CCryEditDoc::LoadLevel(TDocMultiArchive& arrXmlAr, const QString& absoluteCryFilePath)
{
    ...
    P3SystemEventBus::Broadcast(&P3SystemEventBus::Events::OnCryEditorBeginLoad);
    ...
    P3SystemEventBus::Broadcast(&P3SystemEventBus::Events::OnCryEditorEndLoad);
...
void CCryEditDoc::Fetch(const QString& holdName, const QString& relativeHoldPath, bool bShowMessages, FetchPolicy policy)
{
    ...
    case FetchPolicy::DELETE_P3_FILE:
