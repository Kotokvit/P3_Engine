...
namespace AzToolsFramework
{
    ...
    //@{
    constexpr inline AZ::Crc32 EditModeMove = AZ_CRC_CE("org.p3engine.action.editor.editmode.move");
    constexpr inline AZ::Crc32 EditModeRotate = AZ_CRC_CE("org.p3engine.action.editor.editmode.rotate");
    constexpr inline AZ::Crc32 EditModeScale = AZ_CRC_CE("org.p3engine.action.editor.editmode.scale");
    constexpr inline AZ::Crc32 SnapToGrid = AZ_CRC_CE("org.p3engine.action.editor.snaptogrid");
    constexpr inline AZ::Crc32 SnapAngle = AZ_CRC_CE("org.p3engine.action.editor.snapangle");
    //@}
}
