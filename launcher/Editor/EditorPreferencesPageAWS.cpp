...
namespace EditorPreferencesAWSStrings
{
    ...
    static const char* AWSAttributionEnabledName = QT_TRANSLATE_NOOP("EditorPreferencesPageAWS", "Allow <a href=\"https://aws.amazon.com/privacy/\">P3Engine</a> to send information about your use of AWS Core Gem to AWS");
