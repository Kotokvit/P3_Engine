...
Q_LOGGING_CATEGORY(InputDebugging, "p3engine.editor.input")
...
namespace Editor
{
        ...
        , m_stylesheet(new AzQtComponents::O3DEStylesheet(this))
    {
        ...
        setApplicationName("P3Engine Editor");

        installEventFilter(this);

        // Disable our debugging input helpers by default
        QLoggingCategory::setFilterRules(QStringLiteral("p3engine.editor.input.*=false"));
    ...
    {
        // Superseeded by https://github.com/p3engine/p3engine/pull/19554
