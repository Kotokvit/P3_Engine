...
void EditorActionsHandler::OnActionContextRegistrationHook()
{
    // Main Window
    {
        ...
        contextProperties.m_name = "P3Engine Editor";
    ...
    {
        AzToolsFramework::ActionContextProperties contextProperties;
        contextProperties.m_name = "P3Engine Editor - Asset Browser";
    ...
    {
        AzToolsFramework::ActionContextProperties contextProperties;
        contextProperties.m_name = "P3Engine Editor - Console";
    ...
    {
        AzToolsFramework::ActionContextProperties contextProperties;
        contextProperties.m_name = "P3Engine Editor - Entity Inspector";
...
void EditorActionsHandler::OnActionRegistrationHook()
{
    ...
    // New Level
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.file.new";
        ...
        m_hotKeyManagerInterface->SetActionHotKey("p3engine.action.file.new", "Ctrl+N");
    }

    // New Component
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.file.newComponent";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Open Level
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.file.open";
        AzToolsFramework::ActionProperties actionProperties;
        ...
        m_hotKeyManagerInterface->SetActionHotKey("p3engine.action.file.open", "Ctrl+O");
    }
    ...
    // Recent Files
    {
        ...
        for (int index = 0; index < maxRecentFiles; ++index)
        {
            ...
            AZStd::string actionIdentifier = AZStd::string::format("p3engine.action.file.recent.file%i", index + 1);
    ...
    // Clear Recent Files
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.file.recent.clearAll";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Save
    {
        ...
        m_actionManagerInterface->RegisterAction(
            EditorIdentifiers::MainWindowActionContextIdentifier, "p3engine.action.file.save", actionProperties,
        ...
        m_actionManagerInterface->InstallEnabledStateCallback("p3engine.action.file.save", IsLevelLoaded);
        m_actionManagerInterface->AddActionToUpdater(EditorIdentifiers::LevelLoadedUpdaterIdentifier, "p3engine.action.file.save");
        
        m_hotKeyManagerInterface->SetActionHotKey("p3engine.action.file.save", "Ctrl+S");
    }
    ...
    // Save As...
    {
        ...
        m_actionManagerInterface->RegisterAction(
            EditorIdentifiers::MainWindowActionContextIdentifier, "p3engine.action.file.saveAs", actionProperties,
            []
            {
        ...
        m_actionManagerInterface->InstallEnabledStateCallback("p3engine.action.file.saveAs", IsLevelLoaded);
        m_actionManagerInterface->AddActionToUpdater(EditorIdentifiers::LevelLoadedUpdaterIdentifier, "p3engine.action.file.saveAs");
    }

    // Save Level Statistics
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.file.saveLevelStatistics";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.project.editSettings";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.platform.editSettings";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // New Project
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.project.new";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Open Project
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.project.open";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Show Log File
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.file.showLog";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Undo
    {
        ...
        m_actionManagerInterface->AddActionToUpdater(EditorIdentifiers::UndoRedoUpdaterIdentifier, "p3engine.action.edit.undo");

        m_hotKeyManagerInterface->SetActionHotKey("p3engine.action.edit.undo", "Ctrl+Z");
    }
    ...
    // Redo
    {
        ...
        // Trigger update after every undo or redo operation
        m_actionManagerInterface->AddActionToUpdater(EditorIdentifiers::UndoRedoUpdaterIdentifier, "p3engine.action.edit.redo");

        m_hotKeyManagerInterface->SetActionHotKey("p3engine.action.edit.redo", "Ctrl+Shift+Z");
    }

    // Angle Snapping
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.edit.snap.toggleAngleSnapping";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Grid Snapping
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.edit.snap.toggleGridSnapping";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Show Grid
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.edit.snap.toggleShowingGrid";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Global Preferences
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.edit.globalPreferences";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.edit.editorSettingsManager";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        const AZStd::string_view actionIdentifier = "p3engine.action.entity.rename";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        const AZStd::string_view actionIdentifier = "p3engine.action.entityOutliner.findEntity";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Play Game
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.game.play";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Play Game (Maximized)
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.game.playMaximized";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Simulate
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.game.simulate";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.game.movePlayerAndCameraSeparately";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Stop All Sounds
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.game.audio.stopAllSounds";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.game.audio.refresh";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Error Report
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.game.debugging.errorDialog";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.game.debugging.toolboxMacros";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Lua Editor
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.tools.luaEditor";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.layout.componentEntityLayout";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Save Layout...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.layout.save";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.layout.restoreDefault";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Go to Position...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.view.goToPosition";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Center on Selection
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.view.centerOnSelection";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Show Icons
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.view.toggleIcons";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Show Helpers
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.view.showHelpers";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.view.showSelectedEntityHelpers";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Hide Helpers
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.view.hideHelpers";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Refresh Style
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.view.refreshEditorStyle";
        AzToolsFramework::ActionProperties actionProperties;
    ...
    // Tutorials
    {
        ...
        m_actionManagerInterface->RegisterAction(
            EditorIdentifiers::MainWindowActionContextIdentifier, "p3engine.action.help.tutorials", actionProperties,
            [cryEdit = m_cryEditApp]
            {
    ...
    // Open 3D Engine Documentation
    {
        ...
        m_actionManagerInterface->RegisterAction(
            EditorIdentifiers::MainWindowActionContextIdentifier, "p3engine.action.help.documentation.p3engine", actionProperties,
            [cryEdit = m_cryEditApp]
            {
    ...
    // Release Notes
    {
        ...
        m_actionManagerInterface->RegisterAction(
            EditorIdentifiers::MainWindowActionContextIdentifier, "p3engine.action.help.documentation.releasenotes", actionProperties,
            [cryEdit = m_cryEditApp]
            {
    ...
    // GameDev Blog
    {
        ...
        m_actionManagerInterface->RegisterAction(
            EditorIdentifiers::MainWindowActionContextIdentifier, "p3engine.action.help.resources.gamedevblog", actionProperties,
            [cryEdit = m_cryEditApp]
            {
    ...
    // Forums
    {
        ...
        m_actionManagerInterface->RegisterAction(
            EditorIdentifiers::MainWindowActionContextIdentifier, "p3engine.action.help.resources.forums", actionProperties,
            [cryEdit = m_cryEditApp]
            {
    ...
    {
        AzToolsFramework::ActionProperties actionProperties;
        actionProperties.m_name = "&About P3Engine";
        actionProperties.m_category = "Help";

        m_actionManagerInterface->RegisterAction(
            EditorIdentifiers::MainWindowActionContextIdentifier, "p3engine.action.help.abouto3de", actionProperties,
            [cryEdit = m_cryEditApp]
            {
                cryEdit->OnAppAbout();
            }
    ...
    // Welcome
    {
        constexpr AZStd::string_view actionIdentifier = "p3engine.action.help.welcome";
        AzToolsFramework::ActionProperties actionProperties;
...
void EditorActionsHandler::OnWidgetActionRegistrationHook()
{
    // Help - Search Documentation Widget
    {
        ...
        auto outcome = m_actionManagerInterface->RegisterWidgetAction(
            "p3engine.widgetAction.help.searchDocumentation",
    ...
    // Expander
    {
        ...
        m_actionManagerInterface->RegisterWidgetAction(
            "p3engine.widgetAction.expander",
            widgetActionProperties,
            [&]
            {
    ...
    // Play Controls - Label
    {
        ...
        m_actionManagerInterface->RegisterWidgetAction(
            "p3engine.widgetAction.game.playControlsLabel",
            widgetActionProperties,
            [&]
            {
    ...
    // Prefab Edit Visual Mode Selection Widget
    {
        ...
        auto outcome = m_actionManagerInterface->RegisterWidgetAction(
            "p3engine.widgetAction.prefab.editVisualMode",
            widgetActionProperties,
            []() -> QWidget*
            {
    ...
    // Viewport - Field of View Property Widget
    {
        ...
        auto outcome = m_actionManagerInterface->RegisterWidgetAction(
            "p3engine.widgetAction.viewport.fieldOfView",
            widgetActionProperties,
            []() -> QWidget*
            {
    ...
    // Viewport - Camera Speed Scale Property Widget
    {
        ...
        auto outcome = m_actionManagerInterface->RegisterWidgetAction(
            "p3engine.widgetAction.viewport.cameraSpeedScale",
            widgetActionProperties,
            []() -> QWidget*
            {
    ...
    // Viewport - Grid Size Property Widget
    {
        ...
        auto outcome = m_actionManagerInterface->RegisterWidgetAction(
            "p3engine.widgetAction.viewport.gridSnappingSize",
            widgetActionProperties,
            []() -> QWidget*
            {
    ...
    // Viewport - Angle Size Property Widget
    {
        ...
        auto outcome = m_actionManagerInterface->RegisterWidgetAction(
            "p3engine.widgetAction.viewport.angleSnappingSize",
            widgetActionProperties,
            []() -> QWidget*
            {
...
void EditorActionsHandler::OnMenuBindingHook()
{
    ...
    // File
    {
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::FileMenuIdentifier, "p3engine.action.file.new", 100);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::FileMenuIdentifier, "p3engine.action.file.newComponent", 110);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::FileMenuIdentifier, "p3engine.action.file.open", 200);
        m_menuManagerInterface->AddSubMenuToMenu(EditorIdentifiers::FileMenuIdentifier, EditorIdentifiers::RecentFilesMenuIdentifier, 300);
        {
            ...
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::RecentFilesMenuIdentifier, "p3engine.action.file.recent.clearAll", 300);
        }
        m_menuManagerInterface->AddSeparatorToMenu(EditorIdentifiers::FileMenuIdentifier, 400);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::FileMenuIdentifier, "p3engine.action.file.save", 500);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::FileMenuIdentifier, "p3engine.action.file.saveAs", 600);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::FileMenuIdentifier, "p3engine.action.file.saveLevelStatistics", 700);
        m_menuManagerInterface->AddSeparatorToMenu(EditorIdentifiers::FileMenuIdentifier, 800);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::FileMenuIdentifier, "p3engine.action.project.new", 900);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::FileMenuIdentifier, "p3engine.action.project.open", 1000);
        m_menuManagerInterface->AddSeparatorToMenu(EditorIdentifiers::FileMenuIdentifier, 1100);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::FileMenuIdentifier, "p3engine.action.file.showLog", 1200);
        m_menuManagerInterface->AddSeparatorToMenu(EditorIdentifiers::FileMenuIdentifier, 1300);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::FileMenuIdentifier, "p3engine.action.editor.exit", 1400);
    }

    // Edit
    {
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::EditMenuIdentifier, "p3engine.action.edit.undo", 100);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::EditMenuIdentifier, "p3engine.action.edit.redo", 200);
        ...
        m_menuManagerInterface->AddSubMenuToMenu(EditorIdentifiers::EditMenuIdentifier, EditorIdentifiers::EditModifyMenuIdentifier, 1800);
        {
            ...
            {
                m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::EditModifySnapMenuIdentifier, "p3engine.action.edit.snap.toggleGridSnapping", 100);
                m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::EditModifySnapMenuIdentifier, "p3engine.action.edit.snap.toggleAngleSnapping", 200);
            }
        ...
        {
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::EditSettingsMenuIdentifier, "p3engine.action.edit.globalPreferences", 100);
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::EditSettingsMenuIdentifier, "p3engine.action.edit.editorSettingsManager", 200);
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::EditSettingsMenuIdentifier, "p3engine.action.project.editSettings", 300);
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::EditSettingsMenuIdentifier, "p3engine.action.platform.editSettings", 400);
    ...
    // Game
    {
        ...
        {
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::PlayGameMenuIdentifier, "p3engine.action.game.play", 100);
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::PlayGameMenuIdentifier, "p3engine.action.game.playMaximized", 200);
        }
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::GameMenuIdentifier, "p3engine.action.game.simulate", 200);
        ...
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::GameMenuIdentifier, "p3engine.action.game.movePlayerAndCameraSeparately", 700);
        ...
        {
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::GameAudioMenuIdentifier, "p3engine.action.game.audio.stopAllSounds", 100);
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::GameAudioMenuIdentifier, "p3engine.action.game.audio.refresh", 200);
        }
        ...
        {
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::GameDebuggingMenuIdentifier, "p3engine.action.game.debugging.errorDialog", 100);
            ...
            m_menuManagerInterface->AddSubMenuToMenu(EditorIdentifiers::GameDebuggingMenuIdentifier, EditorIdentifiers::ToolBoxMacrosMenuIdentifier, 300);
            {
                ...
                m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ToolBoxMacrosMenuIdentifier, "p3engine.action.game.debugging.toolboxMacros", 300);
            }
        }
    }
    ...
    // Tools
    {
        m_menuManagerInterface->AddActionToMenu(
            ...
            "p3engine.action.tools.luaEditor",
            m_actionManagerInterface->GenerateActionAlphabeticalSortKey("p3engine.action.tools.luaEditor")
        );
    }
    ...
    // View
    {
        ...
        {
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::LayoutsMenuIdentifier, "p3engine.action.layout.componentEntityLayout", 100);
            ...
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::LayoutsMenuIdentifier, "p3engine.action.layout.save", 500);
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::LayoutsMenuIdentifier, "p3engine.action.layout.restoreDefault", 600);
        }
        ...
        {
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportMenuIdentifier, "p3engine.action.view.goToPosition", 100);
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportMenuIdentifier, "p3engine.action.view.centerOnSelection", 200);
            m_menuManagerInterface->AddSubMenuToMenu(EditorIdentifiers::ViewportMenuIdentifier, EditorIdentifiers::GoToLocationMenuIdentifier, 300);
            {
                ...
                {
                    const AZStd::string actionIdentifier = AZStd::string::format("p3engine.action.view.bookmark[%i].goTo", index);
            ...
            m_menuManagerInterface->AddSubMenuToMenu(EditorIdentifiers::ViewportMenuIdentifier, EditorIdentifiers::SaveLocationMenuIdentifier, 400);
            {
                for (int index = 0; index < m_defaultBookmarkCount; ++index)
                {
                    const AZStd::string actionIdentifier = AZStd::string::format("p3engine.action.view.bookmark[%i].save", index);
        ...
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewMenuIdentifier, "p3engine.action.view.refreshEditorStyle", 300);
    }

    // Help
    {
        m_menuManagerInterface->AddWidgetToMenu(EditorIdentifiers::HelpMenuIdentifier, "p3engine.widgetAction.help.searchDocumentation", 100);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::HelpMenuIdentifier, "p3engine.action.help.tutorials", 200);
        ...
        {
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::HelpDocumentationMenuIdentifier, "p3engine.action.help.documentation.p3engine", 100);
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::HelpDocumentationMenuIdentifier, "p3engine.action.help.documentation.gamelift", 200);
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::HelpDocumentationMenuIdentifier, "p3engine.action.help.documentation.releasenotes", 300);
        }
        ...
        {
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::HelpGameDevResourcesMenuIdentifier, "p3engine.action.help.resources.gamedevblog", 100);
            m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::HelpGameDevResourcesMenuIdentifier, "p3engine.action.help.resources.forums", 200);
        }
        m_menuManagerInterface->AddSeparatorToMenu(EditorIdentifiers::HelpMenuIdentifier, 500);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::HelpMenuIdentifier, "p3engine.action.help.abouto3de", 600);
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::HelpMenuIdentifier, "p3engine.action.help.welcome", 700);
    }
    ...
    m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::EntityOutlinerContextMenuIdentifier, "p3engine.action.entity.rename", 70100);
    m_menuManagerInterface->AddSeparatorToMenu(EditorIdentifiers::EntityOutlinerContextMenuIdentifier, 80000);
    m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::EntityOutlinerContextMenuIdentifier, "p3engine.action.view.centerOnSelection", 80100);
    ...
    m_menuManagerInterface->AddActionToMenu(
        EditorIdentifiers::ViewportContextMenuIdentifier, "p3engine.action.entityOutliner.findEntity", 80100);
}
...
void EditorActionsHandler::OnToolBarBindingHook()
{
    ...
    // Play Controls
    {
        m_toolBarManagerInterface->AddWidgetToToolBar(EditorIdentifiers::PlayControlsToolBarIdentifier, "p3engine.widgetAction.expander", 100);
        m_toolBarManagerInterface->AddSeparatorToToolBar(EditorIdentifiers::PlayControlsToolBarIdentifier, 200);
        m_toolBarManagerInterface->AddWidgetToToolBar(EditorIdentifiers::PlayControlsToolBarIdentifier, "p3engine.widgetAction.game.playControlsLabel", 300);
        m_toolBarManagerInterface->AddActionWithSubMenuToToolBar(
            EditorIdentifiers::PlayControlsToolBarIdentifier, "p3engine.action.game.play", EditorIdentifiers::PlayGameMenuIdentifier, 400);
        m_toolBarManagerInterface->AddSeparatorToToolBar(EditorIdentifiers::PlayControlsToolBarIdentifier, 500);
        m_toolBarManagerInterface->AddActionToToolBar(EditorIdentifiers::PlayControlsToolBarIdentifier, "p3engine.action.game.simulate", 600);
    }
}
...
QWidget* EditorActionsHandler::CreateDocsSearchWidget()
{
    ...
    auto searchAction = [lineEdit]
    {
        ...
        if (text.isEmpty())
        {
            QDesktopServices::openUrl(QUrl("https://www.p3engine.org/docs/"));
        }
        else
        {
            QUrl docSearchUrl("https://www.p3engine.org/search/");
...
{
    AZStd::string toolActionIdentifier = AZStd::string::format("p3engine.action.tool.%s", viewPaneName);
...
void EditorActionsHandler::UpdateRecentFileActions()
{
    ...
    for (int counter = 0; counter < maxRecentFiles; ++counter)
    {
        ...
        AZStd::string actionIdentifier = AZStd::string::format("p3engine.action.file.recent.file%i", counter + 1);
...
void EditorActionsHandler::RefreshLayoutActions()
{
    ...
    {
        AZStd::string layoutMenuIdentifier = AZStd::string::format("p3engine.menu.layout[%s]", layoutName.toUtf8().data());
        ...
        if (!m_menuManagerInterface->IsMenuRegistered(layoutMenuIdentifier))
        {
            ...
            {
                AZStd::string actionIdentifier = AZStd::string::format("p3engine.action.layout[%s].load", layoutName.toUtf8().data());
                AzToolsFramework::ActionProperties actionProperties;
            ...
            {
                AZStd::string actionIdentifier = AZStd::string::format("p3engine.action.layout[%s].save", layoutName.toUtf8().data());
                AzToolsFramework::ActionProperties actionProperties;
                actionProperties.m_name = "Save";
            ...
            {
                AZStd::string actionIdentifier = AZStd::string::format("p3engine.action.layout[%s].rename", layoutName.toUtf8().data());
                AzToolsFramework::ActionProperties actionProperties;
                actionProperties.m_name = "Rename...";
            ...
            {
                AZStd::string actionIdentifier = AZStd::string::format("p3engine.action.layout[%s].delete", layoutName.toUtf8().data());
                AzToolsFramework::ActionProperties actionProperties;
...
void EditorActionsHandler::RefreshToolboxMacroActions()
{
    ...
    for (int macroIndex = 0; macroIndex < macroCount; ++macroIndex)
    {
        ...
        {
            AZStd::string toolboxMacroActionIdentifier = AZStd::string::format("p3engine.action.toolboxMacro[%s]", macro->GetTitle().toStdString().c_str());
...
void EditorActionsHandler::RefreshToolActions()
{
    ...
    for (const auto& viewpane : viewpanes)
    {
        ...
        AZStd::string toolActionIdentifier = AZStd::string::format("p3engine.action.tool.%s", viewpane.m_name.toUtf8().data());
