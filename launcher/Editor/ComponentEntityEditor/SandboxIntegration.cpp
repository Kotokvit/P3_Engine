...
void SandboxIntegrationManager::OnActionRegistrationHook()
{
    ...
    // Create entity
    {
        const AZStd::string_view actionIdentifier = "p3engine.action.sandbox.createEntity";
...
void SandboxIntegrationManager::OnMenuBindingHook()
{
    ...
    auto outcome = menuManagerInterface->AddActionToMenu(EditorIdentifiers::EntityOutlinerContextMenuIdentifier, "p3engine.action.sandbox.createEntity", 100);

    // Viewport Context Menu
    menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportContextMenuIdentifier, "p3engine.action.sandbox.createEntity", 100);
}
