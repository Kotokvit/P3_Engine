...
public:
    ...
    // This will return a null pointer if P3System is not loaded before
    // Global Sandbox Settings are loaded from the registry before P3System
    // At that stage GetSettingsManager will return null and xml node in
    // memory will not be populated with Sandbox Settings.
    // After m_IEditor is created and P3System loaded, it is possible
