...
namespace EditorPreferencesFilesStrings
{
    ...
    static const char* ScriptsEditorDesc = QT_TRANSLATE_NOOP("EditorPreferencesPageFiles", "Scripts Text Editor (Default to P3Engine internal tool when empty)");
    static const char* ScriptsEditorPlaceholder = QT_TRANSLATE_NOOP("EditorPreferencesPageFiles", "Default to P3Engine internal tool when empty");
