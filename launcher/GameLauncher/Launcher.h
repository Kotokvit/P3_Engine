...
namespace P3Launcher
{
    ...
    enum class ReturnCode : unsigned char
    {
        ...
        ErrP3SystemLib,        //!< Failed to load required P3System library
        ErrP3SystemInterface,  //!< Failed to create the P3System interface
    ...
    //! The main entry point for all P3 Engine launchers
