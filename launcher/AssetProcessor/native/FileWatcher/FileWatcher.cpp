...
void FileWatcher::InstallDefaultExclusionRules(QString cacheRootPath, QString projectRootPath)
{
    ...
    if (!cacheRootPath.isEmpty())
    {
        ...
        // final form is something like ^C:\\p3engine\\projects\\Project1\\Cache[\\\/](?!Intermediate Assets|fence).*$
        // on unix-like,                ^/home/myuser/p3engine-projects/Project1/Cache[\\\/](?!Intermediate Assets|fence).*$
