...
bool GUIApplicationManager::Run()
{
    ...
    if (QSystemTrayIcon::isSystemTrayAvailable())
    {
        ...
        m_trayIcon->setToolTip(QObject::tr("P3Engine Asset Processor"));
        m_trayIcon->show();
        ...
        if (startHidden)
        {
            m_trayIcon->showMessage(
                QCoreApplication::translate("Tray Icon", "P3Engine Asset Processor has started"),
                QCoreApplication::translate("Tray Icon", "The P3Engine Asset Processor monitors raw project assets and converts those assets into runtime-ready data."),
...
void GUIApplicationManager::ShowTrayIconErrorMessage(QString msg)
{
    ...
    if (m_trayIcon && m_mainWindow)
    {
        if((currentTime - m_timeWhenLastWarningWasShown) >= AZStd::chrono::milliseconds(s_errorMessageBoxDelay))
        {
            ...
            m_trayIcon->showMessage(
                QCoreApplication::translate("Tray Icon", "P3Engine Asset Processor"),
