...
void ApplicationManagerBase::HandleCommandLineHelp(AZStd::vector<ApplicationManagerBase::APCommandLineSwitch>& commandLineInfo)
{
    ...
    {
        // Other P3Engine tools have a more full featured system for registering command flags
...
void ApplicationManagerBase::InitUuidManager()
{
    ...
    if (settingsRegistry)
    {
        if (settingsRegistry->GetObject(uuidSettings, "/P3Engine/AssetProcessor/Settings/Metadata"))
        {
