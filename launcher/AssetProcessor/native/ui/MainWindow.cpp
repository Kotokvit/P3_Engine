    ...
    QObject::connect(ui->sharedCacheSupport, &QPushButton::clicked, this,
        []()
        {
            QDesktopServices::openUrl(
                QStringLiteral("https://p3engine.org/docs/user-guide/assets/asset-processor/asset-cache-server/"));
...
{
    QDesktopServices::openUrl(
        QStringLiteral("https://p3engine.org/docs/user-guide/assets/pipeline/"));
}
