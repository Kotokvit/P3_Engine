    ...
    void AssetProcessorManager::AssetFailed(AssetProcessor::JobEntry jobEntry)
    {
        ...
        if (IsLfsPointerFile(absolutePathToFile.toUtf8().constData()))
        {
            AZ_Error(AssetProcessor::ConsoleChannel, false,
                ...
                "This issue usually happens if you've downloaded all of P3Engine as a zip file. "
                "Please sync all of the files from the LFS endpoint following https://www.p3engine.org/docs/welcome-guide/setup/setup-from-github/#fork-and-clone.",
