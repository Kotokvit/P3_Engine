...
foreach(config ${configs})
    include("Platform/Linux/Default/RecastNavigation.API_${config}.cmake" OPTIONAL)
endforeach()
...
set(configs debug;profile;release)
foreach(config ${configs})
    include("Platform/Linux/Default/RecastNavigation.Private.Object_${config}.cmake" OPTIONAL)
endforeach()
...
set(configs debug;profile;release)
foreach(config ${configs})
    include("Platform/Linux/Default/RecastNavigation_${config}.cmake" OPTIONAL)
endforeach()
...
set(configs debug;profile;release)
foreach(config ${configs})
    include("Platform/Linux/Default/RecastNavigation.Editor.API_${config}.cmake" OPTIONAL)
endforeach()
...
set(configs debug;profile;release)
foreach(config ${configs})
    include("Platform/Linux/Default/RecastNavigation.Editor.Private.Object_${config}.cmake" OPTIONAL)
endforeach()
...
set(configs debug;profile;release)
foreach(config ${configs})
    include("Platform/Linux/Default/RecastNavigation.Editor_${config}.cmake" OPTIONAL)
endforeach()
