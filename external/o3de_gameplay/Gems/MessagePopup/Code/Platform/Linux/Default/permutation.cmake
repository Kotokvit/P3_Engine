...
foreach(config ${configs})
    include("Platform/Linux/Default/MessagePopup.Static_${config}.cmake" OPTIONAL)
endforeach()

# Generated by O3DE

ly_add_target(
    NAME MessagePopup IMPORTED GEM_MODULE
    NAMESPACE Gem
    COMPILE_DEFINITIONS
        INTERFACE
...
set(configs debug;profile;release)
foreach(config ${configs})
    include("Platform/Linux/Default/MessagePopup_${config}.cmake" OPTIONAL)
endforeach()
