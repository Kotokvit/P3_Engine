...
foreach(config ${configs})
    include("Platform/Linux/Default/VirtualGamepad.Static_${config}.cmake" OPTIONAL)
endforeach()

# Generated by O3DE

ly_add_target(
    NAME VirtualGamepad IMPORTED GEM_MODULE
    NAMESPACE Gem
    COMPILE_DEFINITIONS
        INTERFACE
...
set(configs debug;profile;release)
foreach(config ${configs})
    include("Platform/Linux/Default/VirtualGamepad_${config}.cmake" OPTIONAL)
endforeach()
