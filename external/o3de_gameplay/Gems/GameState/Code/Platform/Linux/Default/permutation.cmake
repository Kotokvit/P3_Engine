...
foreach(config ${configs})
    include("Platform/Linux/Default/GameState.Static_${config}.cmake" OPTIONAL)
endforeach()

# Generated by O3DE

ly_add_target(
    NAME GameState IMPORTED GEM_MODULE
    NAMESPACE Gem
    COMPILE_DEFINITIONS
        INTERFACE
...
set(configs debug;profile;release)
foreach(config ${configs})
    include("Platform/Linux/Default/GameState_${config}.cmake" OPTIONAL)
endforeach()
