...
foreach(config ${configs})
    include("Platform/Linux/Default/StartingPointCamera.Static_${config}.cmake" OPTIONAL)
endforeach()

# Generated by O3DE

ly_add_target(
    NAME StartingPointCamera IMPORTED GEM_MODULE
    NAMESPACE Gem
    COMPILE_DEFINITIONS
        INTERFACE
...
set(configs debug;profile;release)
foreach(config ${configs})
    include("Platform/Linux/Default/StartingPointCamera_${config}.cmake" OPTIONAL)
endforeach()
